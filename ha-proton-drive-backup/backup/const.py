...
SOURCE_PROTON_DRIVE = "ProtonDrive"
# Kept as an alias so any persisted data/metadata that referenced the original
# source name still resolves.  The addon only ever uses SOURCE_PROTON_DRIVE.
SOURCE_GOOGLE_DRIVE = SOURCE_PROTON_DRIVE
SOURCE_HA = "HomeAssistant"

# Proton Drive (CLI) error codes
